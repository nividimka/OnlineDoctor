package dkgroup.kz.onlinedoctor.ui.appointment.patient.completed
...
import dkgroup.kz.onlinedoctor.presentation.appointment.patient.completed.PatientCompletedAppointmentPresenter
import dkgroup.kz.onlinedoctor.presentation.appointment.patient.completed.PatientCompletedAppointmentView
...
class PatientCompletedAppointmentFragment : MvpAppCompatFragment(), PatientCompletedAppointmentView {
    ...
    @Inject
    @InjectPresenter
    lateinit var presenter: PatientCompletedAppointmentPresenter


    @ProvidePresenter
    fun providePresenter(): PatientCompletedAppointmentPresenter {
        return presenter
    }
    ...
    companion object {
        ...
        fun newInstance(args: Bundle): PatientCompletedAppointmentFragment {
            val fragment = PatientCompletedAppointmentFragment()
