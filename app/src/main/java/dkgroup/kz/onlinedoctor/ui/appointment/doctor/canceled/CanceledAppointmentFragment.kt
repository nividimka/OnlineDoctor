package dkgroup.kz.onlinedoctor.ui.appointment.doctor.canceled
...
class CanceledAppointmentFragment : MvpAppCompatFragment(), CanceledAppointmentView {
    ...
    @Inject
    @InjectPresenter
    lateinit var presenter: CanceledAppointmentPresenter


    @ProvidePresenter
    fun providePresenter(): CanceledAppointmentPresenter {
        return presenter
    }
    ...
    companion object {
        ...
        fun newInstance(args: Bundle): CanceledAppointmentFragment {
            val fragment = CanceledAppointmentFragment()
