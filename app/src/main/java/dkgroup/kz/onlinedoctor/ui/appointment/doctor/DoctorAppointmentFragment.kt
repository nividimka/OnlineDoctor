...
/**
 * Фрагмент для служб, включает в себя табы и меню, которое видно во всех службах
 */
class DoctorAppointmentFragment : Fragment(), OnlineConsultationView {
    ///@brief адаптер для табов, определяет в каком месте будет открываться определенный фрагмент, а так же их названия
    internal lateinit var adapter: DoctorAppointmentAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        adapter = DoctorAppointmentAdapter(childFragmentManager)
    ...
    companion object {
        ...
        fun newInstance(args: Bundle): DoctorAppointmentFragment {
            val fragment = DoctorAppointmentFragment()
