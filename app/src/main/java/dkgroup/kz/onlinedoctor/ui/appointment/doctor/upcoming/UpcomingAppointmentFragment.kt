package dkgroup.kz.onlinedoctor.ui.appointment.doctor.upcoming
...
class UpcomingAppointmentFragment : MvpAppCompatFragment(), UpcomingAppointmentView {
    ...
    @Inject
    @InjectPresenter
    lateinit var presenter: UpcomingAppointmentPresenter


    @ProvidePresenter
    fun providePresenter(): UpcomingAppointmentPresenter {
        return presenter
    }
    ...
    companion object {
        ...
        fun newInstance(args: Bundle): UpcomingAppointmentFragment {
            val fragment = UpcomingAppointmentFragment()
