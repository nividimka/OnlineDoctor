...
@InjectViewState
class PatientCompletedAppointmentPresenter @Inject constructor(
        private val router: FlowRouter,
        private val firestore: FirebaseFirestore,
        private val firebaseUser: FirebaseUser?
) : BasePresenter<PatientCompletedAppointmentView>() {
    var medCard: MedCard? = null
    var appointments: MutableList<Appointment> = ArrayList()

    override fun attachView(view: PatientCompletedAppointmentView?) {
